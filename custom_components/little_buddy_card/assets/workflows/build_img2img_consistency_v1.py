...
VARIATIONS = [
    "three-quarter view, gentle hop, both feet barely off ground",
    "side profile view, standing calm",
    "looking up, curious expression, hands behind back",
    "sitting on a small stool, hands in lap",
    "one hand raised waving, gentle smile",
    "turned slightly, casual stance",
    "looking down shyly, weight on one foot",
    "both arms slightly out for balance, soft stance",
]
...
DENOISE = 0.4  # low = stays near reference (style+clothing locked)
