...
def save_to_comfyui(ui_workflow, name="katharina_hop_v9"):
...
if __name__ == "__main__":
    ...
    api_path = os.path.join(out_dir, "katharina_hop_v9_api.json")
    ui_path = os.path.join(out_dir, "katharina_hop_v9_ui.json")
    ...
    code, body = save_to_comfyui(ui_wf, "katharina_hop_v9")
