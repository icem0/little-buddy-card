...
OUT_DIR = "/root/little-buddy-card/assets/characters/katharina/hop_gif_v3"

WAN_MODEL = "Wan2_2-Animate-14B_fp8_e4m3fn_scaled_KJ.safetensors"
T5_MODEL = "t5xxl_fp16.safetensors"  # User sagt verfügbar - testen ob Wrapper es nimmt
    ...
    return {
        "1": {
            ...
            "inputs": {
                "model": WAN_MODEL,
                "base_precision": "fp16",
                "quantization": "disabled",  # fp8 für 4090
...
if __name__ == "__main__":
    ...
    print(f"=== katharina_hop_gif_v3 (Wan2.2 I2V mit umt5_xxl_fp16) ===")
